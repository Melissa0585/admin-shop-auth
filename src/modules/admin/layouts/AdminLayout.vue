<template>
    ...
    <a class="fixed flex items-center justify-center h-8 pr-2 pl-1 bg-red-600 rounded-full bottom-0 right-0 mr-4 mb-4 shadow-lg text-red-100 hover:bg-red-600"
