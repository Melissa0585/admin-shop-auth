        ...
        <div class="container mx-auto flex max-w-6xl flex-wrap items-center justify-between">
            <a href="#" class="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="mr-3 h-6 text-red-500 sm:h-9">
            ...
            <div class="mt-2 sm:mt-0 sm:flex md:order-2">
                <template v-if="!authStore.isAuthenticated">
                    <RouterLink to="/auth/login" type="button"
                        class=" mr-3 hidden border border-red-700 py-1.5 px-6 text-center text-sm font-medium text-red-700 focus:outline-none focus:ring-4 focus:ring-red-300 md:inline-block rounded-lg">
                        Login
                    </RouterLink>
                ...
                <template v-if="authStore.isAuthenticated">
                    <RouterLink v-if="authStore.isAdmin" to="/admin" type="button"
                        class=" mr-3 hidden border border-red-700 py-1.5 px-6 text-center text-sm font-medium text-red-700 focus:outline-none focus:ring-4 focus:ring-red-300 md:inline-block rounded-lg">
                        Admin
                    </RouterLink>
                    <button 
            ...
            <div class="hidden w-full items-center justify-between md:order-1 md:flex md:w-auto" id="navbar-sticky">
                <ul
                    ...
                    <li>
                        <a href="#"
                            class="block rounded bg-red-700 py-2 pl-3 pr-4 text-white md:bg-transparent md:p-0 md:text-red-700"
                            aria-current="page">Home</a>
                    </li>
                    <li>
                        <a href="#"
                            class="block rounded py-2 pl-3 pr-4 text-gray-700 hover:bg-gray-100 md:p-0 md:hover:bg-transparent md:hover:text-red-700">About</a>
                    </li>
                    <li>
                        <a href="#"
                            class="block rounded py-2 pl-3 pr-4 text-gray-700 hover:bg-gray-100 md:p-0 md:hover:bg-transparent md:hover:text-red-700">Services</a>
                    </li>
                    <li>
                        <a href="#"
                            class="block rounded py-2 pl-3 pr-4 text-gray-700 hover:bg-gray-100 md:p-0 md:hover:bg-transparent md:hover:text-red-700">Contact</a>
                    </li>
                </ul>
            </div>
        </div>
